...
import com.yuxin.util.DateUtil;
import com.yuxin.util.FreemarkerUtils;
import com.yuxin.util.PropertiesUtils;

import com.yuxin.util.StringUtil;
...
public class ServiceImplFactory {
	...
	public static void createserviceImpl() {
		...
		try {
			...
			String javaName = StringUtil.capFrist(clz) + "ServiceImpl";
